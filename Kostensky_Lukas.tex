...
Ukladanie dát je potrebné nie len z dlhodobého hľadiska - teda zálohovanie a archivácia dát, ale je potrebné aj kvôli zdieľanému prístupu počas priebehu samotného výskumu, kedy nad jedným datasetom môže pracovať viacero ľudí. Je teda potrebné vyriešiť zdieľanie dát v teame, rôzne oprávnenia pre osoby, ktoré majú mať k dátam prístup, verzovanie dát.

\section{Open data/Open access}
Taktiež je pri vývoji repozitára potrebné myslieť na možnosť zverejnenia (časti) dát pre širokú verejnosť s možnosťou ich ďalšieho využitia alebo odkazovania sa na ne. Takto zverejnené dáta označujeme pojmom Open data. V prípade zverejnených výzkumov hovoríme o Open access (OA), kde sú k dispozícii dva stupne voľného prístupu. Prvý "gratis open access" garantuje prístup k dátam bez poplatku, druhý " libre open access"  garantuje, že prístup k dátam je taktiež zadarmo, naviac ale oprávňuje k ich ďalšiemu použitiu. Aké konkrétne práva autor udelí, záleží na ňom, využiť môže napríklad Creative Commons licencie[\url{ https://creativecommons.org/}].
